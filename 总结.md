...
![img](https://ask.qcloudimg.com/draft/3246935/v6u6xbtz46.png?imageView2/2/w/1620)
...
从每个分支的功能和约定可以看出，它流程多约束多，对于小规模应用并不适合。 当然 GitFlow 有一些辅助工具 [gitflow](https://github.com/nvie/gitflow) 可以自动化的完成这些任务，对于大型项目也很有帮助。
